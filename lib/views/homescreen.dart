                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FillupWidget(
                            ...
                            onSubmitted: (_) => controller.openSearch(),
                          ...
                          const SizedBox(height: 14),
                          _ForYouSection(controller: controller),
                        ],
                      ),
                    ),
                  ),
    ...
    return Obx(() {
      ...
      return Column(
        children: [
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return FeaturedCard(
                  ...
                  onTap: () => controller.openProductDetails(item.productId),
                );
              },
            ),
          ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: List.generate(controller.featuredItems.length, (index) {
              final selected = index == currentPage;
...
class _TopPicksSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: screenWidth < 360 ? 270 : 290,
      child: Obx(() {
...
class _ResponsiveProductGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ProductCard uses Expanded, so every card must receive
    // a finite height from its parent.
    final double itemHeight = (itemWidth / 1.1) + 130;
